// Please change varible according to your code base.
pipeline{
    
    agent any 
    // Used in Continues deployment
    // From here 
    parameters {
        choice(
            name: 'action',
    ...
    stages {
        ...
        // ============================================jenkins Conytinues integration part (CI)================================================
        stage('Unit test') {
            steps {
                script {
                    sh 'mvn test'
        ...
        stage('Upload artifact to nexus') {
            steps {
                ...
                // search for how to read file using "pipeline utility steps" plugin.
                script {
        ...
        // =============================================jenkins Continues deploy part (CD)=========================================
        ...
        stage('Destroy deployments in EKS cluster') {
